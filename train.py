...
from src import moco, inbatch, relevance_aware
...
def train(opt, model, optimizer, scheduler, step):
    ...
    if opt.crop_method == "4_pair":
        collator = data.Collator_4_pair(opt=opt)
...
if __name__ == "__main__":
    ...
    elif opt.contrastive_mode == "relevance_aware":
        model_class = relevance_aware.RelevanceAware
    else:
